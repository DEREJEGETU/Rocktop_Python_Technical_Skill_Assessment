...
/*
5. Write a query to display FIRSTNAME, GENDER, HEIGHT, RANK by gender order by height, dense rank by gender order by height
...
/*
6. Write a query to display GENDER, FIRSTNAME, WEIGHT, Running weight of current & previous, running wight of current and all following 
